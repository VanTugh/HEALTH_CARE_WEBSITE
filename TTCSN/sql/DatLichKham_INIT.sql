...
-- 8. DatLichKham (booking) minimal definition (kept for FK integrity)
...
-- ChuyenKhoa (9 records, explicit IDs)
...
-- BacSi: 10 (IDs 11..20)
-- ChuyenKhoa: 9 (IDs 1..9)
-- NguoiDung: 10 (IDs 11..20)
-- TrinhDo: 7 (IDs 1..7)
-- CoSoYTe: 1 (ID 1)

-- End of DatLichKham_INIT.sql
