 ...
 * 2. Bác sĩ xác nhận:
 *    - Nếu thanh toán online → DA_XAC_NHAN_CHO_THANH_TOAN (đã duyệt, chờ thanh toán)
 *    - Nếu thanh toán tiền mặt → DA_XAC_NHAN
 * 3. Thanh toán online thành công → DA_XAC_NHAN
...
public enum TrangThaiDatLich {
    ...
    CHO_THANH_TOAN("Chờ thanh toán", "#17A2B8", true), // legacy / other flows
    DA_XAC_NHAN_CHO_THANH_TOAN("Đã xác nhận, chờ thanh toán", "#20C997", true),
    ...
    public boolean isActive() {
        return this == CHO_XAC_NHAN_BAC_SI || 
               this == CHO_THANH_TOAN || 
               this == DA_XAC_NHAN_CHO_THANH_TOAN ||
               this == DA_XAC_NHAN || 
               this == DANG_KHAM;
    }
