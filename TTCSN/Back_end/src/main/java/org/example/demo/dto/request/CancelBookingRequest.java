...
public class CancelBookingRequest {
    ...
    @Size(min = 5, max = 500, message = "Lý do hủy phải từ 5-500 ký tự")
    @Schema(description = "Lý do hủy lịch", example = "Có việc đột xuất không thể sắp xếp được", required = true, minLength = 10, maxLength = 500)
